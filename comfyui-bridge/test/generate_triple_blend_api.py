...
def track_and_download_images(ws, prompt, output_dir="./output_triple_blend"):
    ...
    print("Waiting for DGX Spark to blend and process the three images...")
    ...
    print("Image blending complete! Downloading output file...")
    ...
    saved_files = []
    # Loop through outputs to find generated images (Node 118)
...
def triple_blend_images(img1, img2, img3, prompt_text, aspect_ratio, json_template_path="image_triple_blend_workflow.json"):
    ...
    # Directly map parameters to the three-image workflow nodes
    workflow["41"]["inputs"]["image"] = img1        
    workflow["79"]["inputs"]["image"] = img2        
    workflow["133"]["inputs"]["image"] = img3        
    ...
    try:
        ...
        for path in results:
            print(f"Success! Triple-blended image saved to: {path}")
    finally:
        ws.close()
...
if __name__ == "__main__":
    ...
    # 1. Three Image filenames ALREADY placed inside ComfyUI/input/ folder
    image_one = "raiden_headphones_long.png"
    image_two = "firered_dressup_test.png"
    image_three = "gen_1776990679.png"

    # 2. Text prompt describing how to blend/merge these three images
    my_prompt = "Three women standing together shopping in a beautiful sci-fi city street"

    # 3. Choose Aspect Ratio (Same options as before)
    ...
    triple_blend_images(
        ...
        json_template_path="image_triple_blend_workflow.json" 
    )
